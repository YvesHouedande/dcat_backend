 ...
 * /technique/projets:
 *   get:
 *     summary: Liste tous les projets avec pagination
 ...
 *         schema:
 *           type: string
 *         description: Recherche par nom ou description du projet
 *       - in: query
 *         name: type
 *         schema:
 *           type: string
 ...
 *         schema:
 *           type: string
 *         description: Filtrer par état du projet (en_cours, terminé, etc.)
 *       - in: query
 *         name: site
 *         schema:
 *           type: string
 *         description: Filtrer par site du projet
 *       - in: query
 *         name: dateDebut
 *         schema:
 *           type: string
