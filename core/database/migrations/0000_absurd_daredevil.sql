...
ALTER TABLE "intervention" ADD CONSTRAINT "intervention_demande_id_sollicitation_id_fk" FOREIGN KEY ("demande_id") REFERENCES "public"."sollicitation"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
