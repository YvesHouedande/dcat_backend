...
const pieceRechange = pgTable("piece_rechange", {
  ...
  quantite: integer("quantite"), // Changé de varchar à integer
});
...
const intervention = pgTable("intervention", {
  ...
  demandeId: integer("demande_id")
    .notNull()
    .references(() => demande.id), // Changé de sollicitation à demande
});
...
const interventionPiece = pgTable(
  "intervention_piece",
  {
    interventionId: integer("intervention_id") // Changé de varchar à integer
      .notNull()
...
const interventionEmploye = pgTable(
  "intervention_employer", // Correction du nom de table
  {
    employeId: integer("employe_id")
      .notNull()
      .references(() => employes.id),
